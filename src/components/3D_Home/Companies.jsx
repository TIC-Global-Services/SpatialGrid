...
const Companies = () => {
  const LogoCloud = [
    {
      name: 'Brand Power',
      image: imagePath.BrandPower,
    },
    {
      name: 'Medha',
      image: imagePath.Medha,
    },
    {
      name: 'Ministry of Defence',
      image: imagePath.MinistryOfDefence,
    },
    {
      name: 'Raghava',
      image: imagePath.Raghava,
    },
    {
      name: 'ISRO',
      image: imagePath.ISRO,
    },
    {
      name: 'SCCL',
      image: imagePath.SCCL,
    },
    {
      name: 'NRSC',
      image: imagePath.NRSC,
    },
    {
      name: 'RST',
      image: imagePath.RST,
    ...
    {
      name: 'Creme21',
      image: imagePath.Creme21,
    },
    {
      name: 'Americana',
      image: imagePath.Americana,
    },
    {
      name: 'Life Sciences',
      image: imagePath.LifeSciences,
    },
  ];
        ...
        <div className="flex justify-center gap-12">
          {row1.map((company, idx) => (
            <img
              ...
              src={company.image}
              alt={company.name}
              className=" w-32 h-20 object-contain opacity-90 hover:opacity-100 transition"
            />
          ))}
        </div>
